import type { MealItem, MealSummary, Prediction } from '../../shared/meal';
...
class MealModel {
   ...
   */
  static parseMarkdown(content: string): MealItem[] {
    if (!content) return [];
